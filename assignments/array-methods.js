...
//This looks like a filter method.
...
var total = ticketPriceTotal.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
...
var donationAverage = donations.reduce((accumulator, currentValue) => accumulator + currentValue, 0);

console.log(donationAverage / donations.length);

// Problem 2
//Runner order confirmation
let emailTemplate = [];

runners.forEach((runner) => {
	emailTemplate.push(`Hello ${runner.first_name}! Thank you for registering for this race. We are sending this email to confirm your address of ${runner.email}. Your gracious donation of $${runner.donation} is being donated to Childrens Hospital.`);
})
